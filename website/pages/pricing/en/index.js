module.exports = {
  ...
  PRICING_EXAMPLE_1_DESCRIPTION: 'If you selected the Start plan, added 1,000 devices that sends a package of 6 variables at every 1 hour to store the data (real-time and action verification to be done separately), your charges would be estimated as follows:',
  ...
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_USAGE_VALUE1: 'Number of Data Input Transactions = 6 * 1,000 = 6,000/h',
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_USAGE_VALUE2: 'Recommended provision = 10,000/h',
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_USAGE_VALUE3: 'Monthly cost for Data Input Transaction = $15',
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_USAGE_VALUE4: 'Number of register (month) = 6 * 1,000 * 24 * 30 = 4,320,000',
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_USAGE_VALUE5: 'Recommended provision = 5 Million registers',
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_USAGE_VALUE6: 'Monthly cost for the Data storage = $ 60',
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_USAGE_VALUE7: 'The monthly cost for Services usage = $15 + $60 = $75',
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_CHARGES: 'Total monthly charges:',
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_CHARGES_VALUE1: 'Total monthly charges = Plan charges + Usage charges = $49 + $75 = $124',
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_CHARGES_VALUE2: 'or about $0.12 / device / mo',
  PRICING_EXAMPLE_2: 'Pricing Example 2',
  PRICING_EXAMPLE_2_DESCRIPTION1: 'If you selected the Starter Plan, added 1,000 devices that sends a package of 6 variables at every 1 hour each.',

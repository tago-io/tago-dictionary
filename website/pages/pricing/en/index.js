module.exports = {
  ...
  PRICING_EXAMPLE_1_DESCRIPTION: 'If you select the Starter plan, add 100 devices that sends a package of 4 variables at every 1 hour to store the data, your charges would be estimated as follows:',
  ...
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_USAGE_VALUE1: 'Hourly Data Input Transactions = 4 * 100 = 400/h',
  ...
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_USAGE_VALUE4: 'Number of registers stored per month = 4 * 100 * 24 * 30 = 288,000',
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_USAGE_VALUE5: 'Recommended provision = 1 Million registers',
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_USAGE_VALUE6: 'Monthly cost for the Data storage = $ 15',
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_USAGE_VALUE7: 'Monthly cost for Services usage = $0 + $15 = $15',
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_CHARGES: 'Total monthly charges:',
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_CHARGES_VALUE1: 'Estimated monthly charges = Plan + Services charges = $49 + $15 = $64',
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_CHARGES_VALUE2: 'or about $0.64 /device',
  PRICING_EXAMPLE_2: 'Pricing Example 2',
  PRICING_EXAMPLE_2_DESCRIPTION1: 'If you select the Scale Plan, add 1,000 devices that sends a package of 4 variables at every 1 hour each.',
  PRICING_EXAMPLE_2_DESCRIPTION2: 'Your charges would be estimated as follows:',
  ...
  PRICING_EXAMPLE_2_MONTHLY_SERVICE_USAGE_VALUE1: 'Hourly Data Input Transactions = 4 * 1,000 = 4,000/h',
  PRICING_EXAMPLE_2_MONTHLY_SERVICE_USAGE_VALUE2: 'Recommended provision = 5,000/h',
  PRICING_EXAMPLE_2_MONTHLY_SERVICE_USAGE_VALUE3: 'Monthly cost for Data Input Transaction = $0',
  PRICING_EXAMPLE_2_MONTHLY_SERVICE_USAGE_VALUE4: 'Number of registers stored per month = 4 * 1,000 * 24 * 30 = 2,880,000',
  ...
  PRICING_EXAMPLE_2_MONTHLY_SERVICE_USAGE_VALUE9: 'Monthly cost for Services = $20 + $40 = $65',
  PRICING_EXAMPLE_2_MONTHLY_SERVICE_USAGE_VALUE10: '',
  PRICING_EXAMPLE_2_MONTHLY_SERVICE_CHARGES: 'Total monthly charges:',
  PRICING_EXAMPLE_2_MONTHLY_SERVICE_CHARGES_VALUE1: 'Estimated monthly charges = Plan + Services charges = $199 + $65 = $264',
  PRICING_EXAMPLE_2_MONTHLY_SERVICE_CHARGES_VALUE2: 'or about $0.26 /device',
  ...
  PRICING_RESPONSE4: 'Tago accepts most major credit cards for payment. In specific cases we may be able to invoice customers directly, talk to our Sales Team for questions regarding payment.',
  ...
  PRICING_CONNECT_UNLIMITED_NUMBER_DEVICES: 'Maximum number of devices',
  PRICING_UP_TO: 'up to',
  ...
  PRICING_BUILD_UNLIMITED_NUMBER_DASHBOARDS: 'Maximum number of dashboards',
  ...
  BRAND_ENGAGEMENT: 'TagoRun - Deploying Your Application',
  ...
  PRICING_CALCULATOR_HOFTENDATA_SEC: 'Seconds',
  PRICING_CALCULATOR_HOFTENDATA_MIN: 'Minutes',
  PRICING_CALCULATOR_HOFTENDATA_HOUR: 'Hours',
  PRICING_CALCULATOR_HWILLRUNAN: 'Will you run Analysis when data arrives?',
  PRICING_CALCULATOR_YES: 'Yes',
  PRICING_CALCULATOR_NO: 'No',
  PRICING_CALCULATOR_HMSMS: 'How many SMS alerts will you send each hour?',
  PRICING_CALCULATOR_HMEMAIL: 'How many Email alerts will you send each hour?',
  PRICING_CALCULATOR_SERVNAME: 'Services name',
  PRICING_CALCULATOR_CALCUSE: 'Calculated Use',

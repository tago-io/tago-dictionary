module.exports = {
  ...
  PRICING_EXAMPLE_1_DESCRIPTION: 'If you select the Starter plan, add 1,000 devices that sends a package of 4 variables at every 1 hour to store the data (real-time and action verification not necessary), your charges would be estimated as follows:',
  ...
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_USAGE_VALUE1: 'Hourly Data Input Transactions = 4 * 1,000 = 4,000/h',
  ...
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_USAGE_VALUE4: 'Number of registers stored per month = 4 * 1,000 * 24 * 30 = 2,880,000',
  ...
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_USAGE_VALUE7: 'Monthly cost for Services usage = $0 + $40 = $40',
  ...
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_CHARGES_VALUE2: 'or about $0.09 /device',
  PRICING_EXAMPLE_2: 'Pricing Example 2',
  PRICING_EXAMPLE_2_DESCRIPTION1: 'If you select the Starter Plan, add 1,000 devices that sends a package of 4 variables at every 1 hour each.',
  ...
  PRICING_EXAMPLE_2_MONTHLY_SERVICE_USAGE_VALUE1: 'Hourly Data Input Transactions = 4 * 1,000 * 2 = 8,000/h   (1 additional transaction per register to verify Actions)',
  ...
  PRICING_EXAMPLE_2_MONTHLY_SERVICE_USAGE_VALUE7: 'Hourly Analysis runs = 1,000/h',
  ...
  PRICING_CALCULATOR_HWILLRUNAN: 'Will you run Analysis each time data arrives?',
  PRICING_CALCULATOR_YES: 'Yes',
  PRICING_CALCULATOR_NO: 'No',
  PRICING_CALCULATOR_HMSMS: 'How many SMS alerts you\'ll send by hour ?',
  PRICING_CALCULATOR_HMEMAIL: 'How many E-mail alerts you\'ll send by hour ?',
  PRICING_CALCULATOR_SERVNAME: 'Services name',
  PRICING_CALCULATOR_CALCUSE: 'Calculated Use',
  PRICING_CALCULATOR_SHOWPRICES: 'Show Prices',
  ...
  PRICING_CALCULATOR_SHOWPRICES: 'Show Prices',
  PRICING_CALCULATOR_INFO: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque risus mi, tempus quis placerat ut, porta nec nulla. Et dictum felis venenatis efficitur.',
};

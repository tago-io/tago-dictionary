module.exports = {
  ...
  PRICING_EXAMPLE_1_MONTHLY_SERVICE_USAGE_VALUE1: 'Numero de Transações de Entradas de dados = 4 * 1,000 = 4,000/h.',
  ...
  PRICING_RESPONSE1: "Diferente de outros provedores, o Tago não cobra pelo número de dispositivos, painéis ou até usuários. Nosso modelo é baseado no uso real dos serviços, ou em outras palavras, o sistema cobra por transações e pelas ferramentas. que são disponibilizados para você dependendo do seu plano. Assim, a fatura mensal será uma soma do plano que você selecionou mais o uso real dos serviços. Você também pode incluir alguns complementos, como os planos de suporte.",
  PRICING_QUESTION2: 'Qual é o ciclo de faturamento da Tago?',
  PRICING_RESPONSE2: 'O Tago fecha o período de cobrança à meia-noite do último dia de cada mês. Geralmente, as faturas estão disponíveis nos primeiros quatro dias do mês subsequente. ',
  ...
  PRICING_RESPONSE4: 'A Tago aceita a maioria dos principais cartões de crédito para pagamento. Em casos específicos, poderemos cobrar os clientes diretamente, converse com nossa equipe de vendas para mais detalhes.',
  ...
  PRICING_RESPONSE7: 'Primeiro, sua assinatura permanecerá ativa no nível atual até o final do período de faturamento que você já pagou. Então, enquanto no plano gratuito, nosso sistema forçará a política de retenção de dados por 30 dias - ou seja, todos os dados com registro de data e hora mais antigos serão removidos. Portanto, recomendamos que você planeje essa operação com cuidado para evitar a perda de dados indesejados.',

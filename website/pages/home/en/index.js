module.exports = {
  ...
  BUILD_YOUR_APPLICATION_IN_ON_TIME_DESCRIPTION: 'Start building your connected product application using our dashboard examples and the connected hardware. Our environment drives collaboration among developers, users and business players to speed up the project implementation.',
  SHARE_YOUR_SOLUTIONS_EASILY: 'Share your solutions easily',
  SHARE_YOUR_SOLUTIONS_EASILY_DESCRIPTION: "In a connected world, sharing is a key to success. Share your dashboards and data with internal and external users securely with a few clicks. It's easy to share solutions with anyone – even if they don't have a Tago account.",
  SCALE_UP_SMOOTHLY: 'Scale up smoothly',
  SCALE_UP_SMOOTHLY_DESCRIPTION: "Add devices and users as your applications expand. Organize all your applications, users and devices under one management tool. Tago offers all the 24/7 monitoring tools, so you don't need to worry about the operation.",
  GO_BEYOND_IOT_WITH_INTEGRATION: 'Go beyond IoT with integration',
  GO_BEYOND_IOT_WITH_INTEGRATION_DESCRIPTION: 'Tago offers powerful APIs to integrate with external services such as weather forecast, image processing, CRM, ERP, and other systems. Connect with the best services from Google, Microsoft, IBM, and AWS.',

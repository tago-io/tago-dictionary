module.exports = {
  ...
  OUR_PRODUCT_SUBTITLE1: 'Get more from the data generated by your connected product',
  OUR_PRODUCT_SUBTITLE2: 'Learn about the unique features of our platform',
  PRODUCT_OVERVIEW: 'Overview',
  PRODUCT_OVERVIEW_TITLE1: 'Improve and create new sources of information',
  ...
  PRODUCT_OVERVIEW_LINK1: 'More on Connectivity',
  ...
  PRODUCT_OVERVIEW_LINK2: 'More on Analysis',
  ...
  PRODUCT_OVERVIEW_LINK3: 'More on Customization',
  PRODUCT_DEVICE_MANAGEMENT: 'Device Management',
  PRODUCT_DEVICE_MANAGEMENT_H1: 'Device Management',
  ...
  PRODUCT_DEVICE_MANAGEMENT_TITLE2: 'Token Management',
  ...
  PRODUCT_DEVICE_MANAGEMENT_TITLE3: 'Inventory Management',
  ...
  PRODUCT_ANALITICS: 'Analysis',
  PRODUCT_ANALITICS_H1: 'Analysis',
  PRODUCT_ANALITICS_TITLE1: 'Powerful scripts to perform real-time analytics',
  PRODUCT_ANALITICS_DESCRIPTION1: 'Implement your own business rules to instantaneously react to any change in your system. You can perform operations as simple as temperature conversion to image recognition to advanced big data analytics.',
  PRODUCT_ANALITICS_TITLE2: 'Decide in Real-time',
  ...
  PRODUCT_ACTIONS_H1: 'Actions',
  PRODUCT_ACTIONS_TITLE1: 'Prepare data sets and reports to be sent to users or devices by email, SMS, MQTT or HTTP',
  PRODUCT_ACTIONS_DESCRIPTION1: 'Don\'t get limited to just getting more information - take action! Take control of your system by sending data back to devices or to other back-end systems. Tago is easily integrated with third party software using APIs calls combining the Actions and Analysis features. Setup your action to send email, SMS, data to device, post data to another HTTP end point when a certain condition is met.',
  ...
  PRODUCT_DASHBOARDS_H1: 'Dashboards',
  ...
  PRODUCT_CONNECTIVITY: 'Connectivity',
  ...
  PRODUCT_ANALYSIS_SUBTITLE: 'Take actions in real-time to respond to the demands from your devices and users',
  PRODUCT_ANALYSIS_DESCRIPTION1: 'Implement your own business rules to instantaneously react to any change in your system. You can perform operations as simple as temperature convertion to image recognition to advanced big data analytics.',
  ...
  PRODUCT_CUSTOMIZATION_LNIK1: 'Go to API',
  PRODUCT_DESCRIPTION: 'Get more from the data generated by your connected product using the best services designed by TagoIO. Learn what we can offer for you to build dashboards, analytics, notifications, integrations, and to manage users and devices. ',
  CONNECTIVITY_DESCRIPTION: 'TagoIO is integrated with several gateways, sensors, data sources, and network providers to make it easier and faster for you to fully deploy your application. Whether your product will be connected via WiFi, Bluetooth, Sigfox, LoRa, LoRaWAN, 3G, satellite or any other mean, TagoIO can easily be configured to support your application.',
  ANALYSIS_DESCRIPTION: 'Create scripts that will run in real-time to anticipate technical issues and business opportunities  by combining data from your product and other sources. Implement your own business rules to instantaneously react to any change in your system.',
  CUSTOMIZATION_DESCRIPTION: 'Deploy your own environment with dashboards, displaying your own logo, colors, e-mail services, and url using our White-label edition.',
};

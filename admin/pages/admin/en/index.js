module.exports = {
  ...
  NOTIFICATIONS_FROM_USER_REGISTERED: '$0 just created an account on TagoIO. The item you shared is available for him to accept.',
  NOTIFICATIONS_FROM_USER_REGISTERED_FAIL: 'Oops... $0 is now registered on TagoIO, but something went wrong with the sharing. Try to share again.',
  ONLY_UNREAD: 'Only unread',
  OTHER_USERS: 'Other Users',
  RESEND_EMAIL_CONFIRMATION: 'Resend confirmation email',
  TAGO_SYSTEM: 'TagoIO System',
  ...
  HOME_END_USER_INTRO: 'Learn about how to interact with devices connected to their applications. Just select a dashboard and follow the directions to operate the application.',
  ...
  NOTIFICATIONS_INFO_HOME: 'Notifications are messages you receive through the system.',
  DOWNLOAD_OUR_APP: 'Download our app for',
  ACCOUNT_INFO_HOME1: 'You change your account as you like.',
  ACCOUNT_INFO_HOME2: 'Click here to do so!',
  DOWNLOAD_OUR_APP_TITLE: 'Download our app',
  HOME_SUBTITLE_HAS_DASHBOARD: 'You can visit your last dashboard by clicking the button below',
  HOME_SUBTITLE_NO_DASHBOARD: 'You can check out some dashboard examples by clicking the button below',

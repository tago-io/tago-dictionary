module.exports = {
  ...
  HOME_END_USER_INTRO: 'TagoIO has the best tools for users to interact with devices connected to their applications. Just select a dashboard and follow the directions to operate the application.',

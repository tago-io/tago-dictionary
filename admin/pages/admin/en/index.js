module.exports = {
  ...
  TEMPLATE_TAB_DESCRIPTION: 'Send the generated URL to others to access your dashboard through a customized install page.',
  ...
  CUSTOMIZE_TEMPLATE_TITLE: 'Customize',
  CUSTOMIZE_TEMPLATE_DESCRIPTION: 'Add a logo and an image that better represents your template. Images will be shown when users access the URL above.',
  ...
  TEMPLATE_ANALYSIS_SETUP_DESCRIPTION: 'This information will help the user to use the right value in his/her account.',
  TEMPLATE_DASHBOARD_SETUP_TITLE: 'Describe the type of device expected by this dashboard.',

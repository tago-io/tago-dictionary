module.exports = {
  ...
  CUSTOMIZE_TEMPLATE_DESCRIPTION: 'Add a logo and an image that better represents your template. Images will be shown when users access the page using the URL above.',
